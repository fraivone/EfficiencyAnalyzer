...
mask_labels = ["no_Mask","overallGood_Mask","isME21_Mask"] + [ k+"_Mask" for k in cut_labels] + ["DAQMaskedVFAT","DAQMissingVFAT", "DAQError","DAQenabledOH","HVMask"]
...
def calcMuonHit_masks(gemprophit_array, etaID_boundaries_array, maxPropPhi_Err=99999,maxPropR_Err=99999,minpT=0,fiducialR=0,fiducialPhi=0,RangeChi2=[0,99999999],minME1=0,minME2=0,minME3=0,minME4=0):
    ...
    overallGood_Mask = dict_of_masks["isME21_Mask"]  & dict_of_masks["maxPropR_Err_Mask"] & dict_of_masks["maxPropPhi_Err_Mask"] & dict_of_masks["RangeChi2_Mask"] & dict_of_masks["minpT_Mask"] & dict_of_masks["minME1_Mask"] & dict_of_masks["minME2_Mask"] & dict_of_masks["minME3_Mask"] & dict_of_masks["minME4_Mask"] & dict_of_masks["fiducialPhi_Mask"] & dict_of_masks["fiducialR_Mask"]
