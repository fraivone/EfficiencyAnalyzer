...
for displ in mapfile:
    try:
        df = pd.read_csv(glob.glob(mapfile[displ]+"PerEtaFitResults.txt")[0],sep=",")
    except:
    ...
    df_long = df[df["Size"] == "Long"]
    df_short = df[df["Size"] == "Short"]
...
for region in [-1,1]:
    ...
    fig.tight_layout()
    fig.savefig(f"{current_folder}/Region{region}_PeakSeparation.png")
    fig.savefig(f"{current_folder}/Region{region}_PeakSeparation.pdf")
...
axs[0].plot([last_df[(last_df["region"] == -1) & (last_df["layer"] == 1) & (last_df["size"] == "Long")& (last_df["eta"] == eta)]["Zero Crossing Displacement"].iloc[0] for eta in range(1,9)] ,  list(range(1,9)), linestyle='dashed', marker='o', label="Long ly1")
axs[0].plot([last_df[(last_df["region"] == -1) & (last_df["layer"] == 2) & (last_df["size"] == "Long")& (last_df["eta"] == eta)]["Zero Crossing Displacement"].iloc[0] for eta in range(1,9)] ,  list(range(1,9)), linestyle='dashed', marker='o', label="Long ly2")
axs[0].plot([last_df[(last_df["region"] == -1) & (last_df["layer"] == 1) & (last_df["size"] == "Short")& (last_df["eta"] == eta)]["Zero Crossing Displacement"].iloc[0] for eta in range(1,9)] , list(range(1,9)), linestyle='dashed', marker='o', label="Short ly1")
axs[0].plot([last_df[(last_df["region"] == -1) & (last_df["layer"] == 2) & (last_df["size"] == "Short")& (last_df["eta"] == eta)]["Zero Crossing Displacement"].iloc[0] for eta in range(1,9)] , list(range(1,9)), linestyle='dashed', marker='o', label="Short ly2")
axs[0].legend()
...
axs[1].plot([last_df[(last_df["region"] == 1) & (last_df["layer"] == 1) & (last_df["size"] == "Long")& (last_df["eta"] == eta)]["Zero Crossing Displacement"].iloc[0] for eta in range(1,9)] , list(range(1,9)),  linestyle='dashed', marker='o', label="Long ly1")
axs[1].plot([last_df[(last_df["region"] == 1) & (last_df["layer"] == 2) & (last_df["size"] == "Long")& (last_df["eta"] == eta)]["Zero Crossing Displacement"].iloc[0] for eta in range(1,9)] , list(range(1,9)),  linestyle='dashed', marker='o', label="Long ly2")
axs[1].plot([last_df[(last_df["region"] == 1) & (last_df["layer"] == 1) & (last_df["size"] == "Short")& (last_df["eta"] == eta)]["Zero Crossing Displacement"].iloc[0] for eta in range(1,9)] ,list(range(1,9)),  linestyle='dashed', marker='o', label="Short ly1")
axs[1].plot([last_df[(last_df["region"] == 1) & (last_df["layer"] == 2) & (last_df["size"] == "Short")& (last_df["eta"] == eta)]["Zero Crossing Displacement"].iloc[0] for eta in range(1,9)] ,list(range(1,9)),  linestyle='dashed', marker='o', label="Short ly2")
axs[1].legend()
...
fig.tight_layout()
fig.savefig(f"{current_folder}/ZeroCrossingDisplacement.png")
